...
class KeyframeBase {
	...
	public var tweensLength(get, never):Int;
	 ...
	 * @keyword Keyframe, Copy Motion as ActionScript
	 */
	public var scaleX:Float = Math.NaN;
	 ...
	 * @keyword Keyframe, Copy Motion as ActionScript
	 */
	public var scaleY:Float = Math.NaN;
	 ...
	 * @keyword Keyframe, Copy Motion as ActionScript
	 */
	public var skewX:Float = Math.NaN;
	 ...
	 * @keyword Keyframe, Copy Motion as ActionScript
	 */
	public var skewY:Float = Math.NaN;
	 ...
	 * @private (setter)
	 */
	private function set_rotation(value:Float):Float // Use Flash Player behavior: set skewY to rotation and increase skewX by the difference.
	{
		if (Math.isNaN(this.skewX) || Math.isNaN(this.skewY)) {
			this.skewX = value;
		} else {
	 ...
	 * @keyword Keyframe, Copy Motion as ActionScript
	 */
	public var rotationConcat:Float = Math.NaN;
	 ...
	 * @keyword Keyframe, Copy Motion as ActionScript
	 */
	public var useRotationConcat:Bool = false;

	@:meta(ArrayElementType(name = "flash.filters.BitmapFilter"))
	 ...
	 * @keyword Keyframe, Copy Motion as ActionScript
	 */
	public var opaqueBackground:Dynamic = null;
	 ...
	 * @langversion 3.0
	 */
	public var matrix3D:Dynamic = null;
	 ...
	 * @langversion 3.0
	 */
	public var rotationX:Float = Math.NaN;
	 ...
	 * @langversion 3.0
	 */
	public var rotationY:Float = Math.NaN;
	...
	private function setDefaults():Void {
		if (Math.isNaN(this.x)) {
			this.x = 0;
		}
		if (Math.isNaN(this.y)) {
			this.y = 0;
		}
		if (Math.isNaN(this.z)) {
			this.z = 0;
		}
		if (Math.isNaN(this.scaleX)) {
			this.scaleX = 1;
		}
		if (Math.isNaN(this.scaleY)) {
			this.scaleY = 1;
		}
		if (Math.isNaN(this.skewX)) {
			this.skewX = 0;
		}
		if (Math.isNaN(this.skewY)) {
			this.skewY = 0;
		}
		if (Math.isNaN(this.rotationConcat)) {
	 ...
	 * @keyword Keyframe, Copy Motion as ActionScript
	 */
	public function setValue(tweenableName:String, newValue:Float):Void {
		Reflect.setField(this, tweenableName, newValue);
	}

	/**
	 * @private
	 */
	private function hasTween():Bool {
		return false;
	}
	 ...
	 *
	 		 ...
	 		 * @keyword Keyframe, Copy Motion as ActionScript
	 */
	public function affectsTweenable(tweenableName:String = ""):Bool {
		return ((tweenableName == null || tweenableName == "")
			|| !Math.isNaN(Reflect.field(this, tweenableName)) // a valid numerical value exists for the property
			|| (tweenableName == "color" && this.color != null)
			|| (tweenableName == "filters" && this.filters.length > 0)
			|| (tweenableName == "matrix3D" && this.matrix3D != null)
			|| (tweenableName == "matrix" && this.matrix != null)
	 ...
	 */
	public function setAdjustColorProperty(filterIndex:Int, propertyName:String, value:Dynamic):Void {
	 ...
	 */
	private function get_tweensLength():Int {
		return 0;
	}
}
