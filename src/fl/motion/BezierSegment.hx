...
class BezierSegment {
	 ...
	 * @keyword Bezier curve, node, Copy Motion as ActionScript
	 */
	public function getValue(t:Float):Point {
	 ...
	 */
	public function getYForX(x:Float, coefficients:Array<Dynamic> = null):Float // Clamp to range between end points.
	{
		...
		var roots:Array<Dynamic> = getCubicRoots(coefficients[0], coefficients[1], coefficients[2], coefficients[3] - x);
	 ...
	 * @see #getCubicRoots()
	 */
	public static function getCubicCoefficients(a:Float, b:Float, c:Float, d:Float):Array<Dynamic> {
