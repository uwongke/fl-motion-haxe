...
class MotionEvent extends Event {
	 ...
	 */
	public static inline var MOTION_START:String = "motionStart";
	 ...
	 * @eventType motionEnd
	 */
	public static inline var MOTION_END:String = "motionEnd";
	 ...
	 */
	public static inline var MOTION_UPDATE:String = "motionUpdate";
	 ...
	 */
	public static inline var TIME_CHANGE:String = "timeChange";
