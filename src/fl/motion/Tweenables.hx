...
class Tweenables {
	 ...
	 */
	public static inline var SKEW_X:String = "skewX";
	 ...
	 */
	public static inline var SKEW_Y:String = "skewY";
	 ...
	 */
	public static inline var ROTATION_CONCAT:String = "rotationConcat";
